...
public class WalletCloseProcessor implements OperationCommandProcessor {
    ...
    public void processOperation() {
        ...
        Wallet wallet = walletService.close(accountId);
        ...
        user.getAccounts().remove(wallet);
        System.out.printf("Account successfully closed with id:%s from user:%s%n", accountId, user.getLogin());
    }
